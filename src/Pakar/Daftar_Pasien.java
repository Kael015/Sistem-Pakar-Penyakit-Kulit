...
{
String[]judul={"No.Pasien","Nama","Alamat","Kota","No.Telepon","Pekerjaan"};
DefaultTableModel kolom=new DefaultTableModel(null,judul);
    try
    {
    con.setkoneksi();
    con.rs=con.st.executeQuery("select * from pasien");
...
try
{
    con.setkoneksi();
    String nomor=null;
    con.rs=con.st.executeQuery("Select right(no_pasien,3)+1 as no from pasien order by no_pasien desc");
    if(con.rs.next())
    {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Formulir Daftar Pasien ");
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(tcarikode, javax.swing.GroupLayout.Alignment.TRAILING)
    ...
    {
    con.setkoneksi();
    String sql="insert into pasien values('"+tno.getText()+"','"+tnama.getText()+"','"+talamat.getText()+"','"+tkota.getText()+"','"+ttelp.getText()+"','"+tpekerjaan.getText()+"')";
    ...
    {
    con.setkoneksi();
    con.rs=con.st.executeQuery("select * from pasien where no_pasien like '"+tcarikode.getText()+"'");
    if(con.rs.next())
        {
    ...
    {
    con.setkoneksi();
    con.rs=con.st.executeQuery("select * from pasien where nama_pasien like '"+tcarinama.getText()+"'");
    if(con.rs.next())
        {
        tno.setText(con.rs.getString(1));
        tnama.setText(con.rs.getString(2));
    ...
    try
    {
    con.setkoneksi();String sql="update pasien set nama_pasien='"+tnama.getText()+"',alamat='"+talamat.getText()+"',kota='"+tkota.getText()+"',no_telp='"+ttelp.getText()+"',pekerjaan='"+tpekerjaan.getText()+"' where no_pasien='"+tno.getText()+"'";
    con.st.executeUpdate(sql);
    ...
    {
    con.setkoneksi();
    String sql="delete from pasien where no_pasien='"+tcarikode.getText()+"' or nama_pasien='"+tcarinama.getText()+"'";
    con.st.executeUpdate(sql);
    con.rs.close();
